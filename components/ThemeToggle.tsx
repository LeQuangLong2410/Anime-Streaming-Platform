...
export const AnimatedThemeToggle = () => {
  ...
  const [isDark, setIsDark] = useState(true) // Default to dark to match SSR
  ...
  // Always render the same structure, just hide icon content until mounted
  if (!mounted) {
    return (
      <button
