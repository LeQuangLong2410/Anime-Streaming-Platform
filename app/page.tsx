...
export default function Home() {
  ...
  const filteredLatest = useMemo(() => {
    ...
    if (latestFilter === 'Mùa Xuân - 2026') {
      base = animes.filter(a => a.year === 2026 || a.year === '2026' || a.releaseDate?.includes('2026') || a.type === 'xuan')
      ...
      base = animes.filter(a => a.type === 'le' || a.genre.includes('Movie') || a.description.toLowerCase().includes('movie'))
    } else if (latestFilter === 'HH Trung Quốc') {
      base = animes.filter(a => a.type === 'hh' || a.title.toLowerCase().includes('trung quốc') || a.genre.includes('HH Trung Quốc'))
    }
  ...
  const filteredPopular = useMemo(() => {
    ...
    if (popularFilter === 'Mùa Xuân - 2026') {
      base = popularAnime.filter(a => a.year === 2026 || a.year === '2026' || a.releaseDate?.includes('2026'))
...
// === CONFIG FOR NEXT.JS (Server Side) ===
